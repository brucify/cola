...
check_is_free_test() ->
  Bookings = [ {cola_uuid:new(), "C01", 1618078958, 1618082558} % "2021-04-10T18:22:38Z" -> "2021-04-10T19:22:38Z"
             , {cola_uuid:new(), "C01", 1618089758, 1618093358} % "2021-04-10T21:22:38Z" -> "2021-04-10T22:22:38Z"
             , {cola_uuid:new(), "C01", 1618093838, 1618094438} % "2021-04-10T22:30:38Z" -> "2021-04-10T22:40:38Z"
             , {cola_uuid:new(), "C01", 1618105238, 1618119638} % "2021-04-11T01:40:38Z" -> "2021-04-11T05:40:38Z"
             , {cola_uuid:new(), "C01", 1618216838, 1618224038} % "2021-04-12T08:40:38Z" -> "2021-04-12T10:40:38Z"
             ],
  % same start and end
